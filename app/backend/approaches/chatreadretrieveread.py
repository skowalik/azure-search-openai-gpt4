...
class ChatReadRetrieveReadApproach(Approach):
    ...
    """
    system_message_chat_conversation = """Assistant helps with information related to the Port Authority of New York and New Jersey infrastructure, contracts, frequently asked questions (FAQs), and on minority and women owned business entities. Be brief in your answers.
...
{injected_prompt}
"""
    follow_up_questions_prompt_content = """Generate three very brief follow-up questions that the user would likely ask next based on doing business with the Port Authority of New York and New Jersey.
Use double angle brackets to reference the questions, e.g. <<What are the requirements for an MWBE contract?>>.
...
"""
    query_prompt_few_shots = [
        {"role": USER, "content": "Where do I find the solicitation documents?"},
        {"role": ASSISTANT, "content": "Solicitation documents can be found on the Port Authority website: Solicitations/Advertisements Information | Port Authority of New York and New Jersey (panynj.gov)"},
        {"role": USER, "content": "How do I find the status of my certification?"},
        {"role": ASSISTANT, "content": "You may find out the status of your certification by logging into your account at Diversity Management Program - Supplier Diversity - Business Opportunities - Port Authority of New York & New Jersey"},
    ]
